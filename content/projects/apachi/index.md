...
Apachi was an 18 lb hobbyweight combat robot designed and built in 2019–2020. It featured a shuffler drive — six HDPE feet per side actuated by an eccentric mechanism — chosen to gain experience with the drive type and take advantage of the 50% weight bonus shufflers receive in competition. The weapon was an overhead bent bar spinning at approximately 800 RPM, giving 360-degree strike capability.
...
| **Weapon** | Shell spinner, 1200 RPM / 67 MPH |
| **Shell** | 22.5 lb, solid A36 steel (from 250 lb block) |
| **Drive** | Shuffler, 2 modules × 4 UHMWPE feet |
| **Record** | 2–2 Motorama 2022, 1–2 AVC 2022 |
...
|---|---|
| **Weight class** | Featherweight (45 lb) |
| **Weapon** | Shell spinner, 2000 RPM / ~120 MPH |
| **Shell** | 24 lb, ¼" heat-treated 4140 steel, 50° slant |
| **Drive** | Dual shuffler modules, 8 UHMWPE feet, keyed cam shafts |
| **Drive motors** | Badass 3530 470kv |
| **Weapon motor** | Scorpion SII-4035-380KV |
| **ESCs** | iFlight Blitz E80 (drive), Flycolor X-Cross 80A (weapon) |
| **Record** | 5–5 combined, 2–1 NHRL |
